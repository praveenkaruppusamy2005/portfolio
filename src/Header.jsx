...
function Header({scroll,index,setIndex}) {
  ...
  return (
    <div className={`header ${scroll ? 'header-scrolled' : ''}`}>
      ...
      <button className='buttons' style={{backgroundColor:'#9ef01a',borderRadius:'20px'}} onClick={()=>{window.open('https://drive.google.com/file/d/1iQDdHhhfRrtLukKiZU7DHvVrZVhYEaLE/view?usp=sharing')}}>RESUME</button> 
      </div>
      </div>
